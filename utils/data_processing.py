...
DATA_DIR = "data"
WORD_LIST = f"{DATA_DIR}/CSW24defs.csv"
...
# Write to CSV
indian_origin_words.to_csv(f'{DATA_DIR}/indian_words.csv', index=False)
non_indian_words.to_csv(f'{DATA_DIR}/non_indian_words.csv', index=False)